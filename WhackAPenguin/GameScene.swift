...
//  WhackAPenguin
//
//  Created by Tran Hieu on 14/12/2023.
//
...
class GameScene: SKScene {
    ...
    func createSlots() {
        for i in 0..<5 {
            createSlot(at: .init(x: 100+(i*170), y: 410))
        }
        for i in 0..<4 {
            createSlot(at: .init(x: 100*2+(i*170), y: 320))
        }
        for i in 0..<5 {
            createSlot(at: .init(x: 100+(i*170), y: 230))
        }
        for i in 0..<4 {
            createSlot(at: .init(x: 100*2+(i*170), y: 140))
        }
    ...
    func createEnemy() {
        ...
        if numRounds >= 30 {
            ...
            gameOver.position = .init(x: 512, y: 384)
